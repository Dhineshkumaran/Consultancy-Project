  ...
  return (
    <>
      ...
      <section className="max-w-6xl mx-auto font-sans pt-32">
        <h1 className="text-4xl font-bold text-center text-blue-900 border-b-2 border-gray-200 pb-4 mb-14">About Our School</h1>
        ...
        {[
          ...
          <div key={index} className={`flex flex-wrap items-center justify-between gap-8 bg-white p-8 mb-10 rounded-xl shadow-md hover:shadow-xl transition duration-300 ${index % 2 === 1 ? "flex-row-reverse" : ""}`}>
